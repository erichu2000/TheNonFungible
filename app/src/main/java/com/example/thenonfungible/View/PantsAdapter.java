...
public class PantsAdapter extends BaseAdapter {
    private Context context;
    List<Good> pants;

    // Constructor
    public PantsAdapter(Context c, List<Good> pants) {
        context = c;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Good currentPants = pants.get(i);

        Glide.with(context).load(currentPants.getItemImageID()).into(imageView);
